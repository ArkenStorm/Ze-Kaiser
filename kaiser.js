...
const reactionboard = require('./misc-commands/reactionboard');
...
Promise.all([
	sqlite.startDatabase("./db.sqlite"), 
	nosql.startDatabase("./nosql.json")
]).then(async ([sqliteDB, nosqlDB]) => {
	client.on('ready', () => {
